      ...
      <div className="flex h-full grow flex-col">
        ...
        <div className="px-40 flex flex-1 justify-center py-5">
          <div className="flex flex-col w-[512px] max-w-[512px] py-5 flex-1">
            <h2 className="text-[#0c1c17] tracking-light text-[28px] font-bold leading-tight px-4 text-center pb-3 pt-5">Welcome Back!</h2>
            ...
            <form onSubmit={handleSubmit}>
              <div className="flex max-w-[480px] flex-wrap items-end gap-4 px-4 py-3">
                <label className="flex flex-col min-w-40 flex-1">
                  ...
                  <input
                    ...
                    className={`form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-[#0c1c17] focus:outline-0 focus:ring-0 border ${errors.emailid ? 'border-red-500' : 'border-[#cde9df]'} bg-[#f8fcfa] focus:border-[#cde9df] h-14 placeholder:text-[#46a080] p-[15px] text-base font-normal leading-normal`}
              ...
              <div className="flex px-4 py-3">
                ...
                >
                  <span className="truncate">{isSubmitting ? 'Logging in...' : 'Log In'}</span>
                </button>
              </div>
            </form>
